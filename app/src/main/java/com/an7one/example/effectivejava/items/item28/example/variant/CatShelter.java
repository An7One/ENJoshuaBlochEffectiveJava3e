 ...
 */
package com.an7one.example.effectivejava.items.item28.example.variant;

import com.an7one.example.effectivejava.items.item28.example.variant.model.Animal;
import com.an7one.example.effectivejava.items.item28.example.variant.model.Cat;
